...
public class 农学_Session extends com.hzs.Session implements Cloneable, org.hzs.Close {

    private static 农学_Session session = null;

    public static 农学_Session d副本() {
        if (session == null) {
            session = new 农学_Session();
        }
        return (农学_Session) session.clone();
    }
    ...
    @Override
    public 农学_Session set(final String ci_s, final org.hzs.logging.error ci_error) throws org.hzs.logging.error {
        try {
            if (ci_s == null) {
                return null;
            }
            ...
            Logger.getLogger(农学_Session.class.getName()).log(Level.SEVERE, null, ex);
            throw ci_error;
        } finally {
        }
    }
