...
public class 农学 extends org.hzs.server.业务.__ {

    public java.util.TreeMap<Integer, com.hzs.农学_Session> session_集合 = new java.util.TreeMap<>();
    ...
    public 农学() {
        try {
            ...
            i资源指纹.put("农学.hz", "sJs5f9IiMbfa0wyYuMbJx2dEEJCHr8Q/kHnYXr728W84ALELwxIJsn2vhB815rfJaorrypJ7+tjsLu6/8tKaEw==");
            i资源路径.put("base.hz", "http://192.168.0.113/base.hz");
            i资源路径.put("农学.hz", "http://192.168.0.113/农学.hz");
        } catch (error ex) {
            Logger.getLogger(农学.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
        }
    }
    //============================================================================================================
    ...
    public org.hzs.json.JSONObject getSession(final int sessionid_i) {
        com.hzs.农学_Session session = null;
        try {
            session = session_集合.get(sessionid_i);
            if (session == null) {
                session = com.hzs.农学_Session.d副本();
    ...
    public void removeSession(int sessionid_i) {
        com.hzs.农学_Session session = session_集合.get(sessionid_i);
        if (session != null) {
    ...
    public byte[] g处理请求(final String session_s, final byte[] ci客户数据_byteArray) {
        ...
        try {
            ...
            ji自用.session = com.hzs.农学_Session.d副本();
    ...
    private Object g处理请求(final String ci过程_s, final org.hzs.json.JSONObject ci_JSON, final com.hzs.Session session, final org.hzs.logging.error ci_error) throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, java.lang.reflect.InvocationTargetException, InstantiationException, CloneNotSupportedException {
        // <editor-fold defaultstate="collapsed" desc="自用">
        class 自用 implements Cloneable, org.hzs.Close {
