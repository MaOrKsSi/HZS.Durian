...
Ext.onReady(function() {
   ...
   if (Ext.Date) {
      ...
      Ext.Date.dayNames1 = ["周日", "周一", "周二", "周三", "周四", "周五", "周六"];//修改部份
      Ext.Date.dayNames2 = ["日", "一", "二", "三", "四", "五", "六"];//修改部份
      Ext.Date.monthNames1 = ["一","二","三","四","五","六","七","八","九","十","十一","十二"];//修改部份
   ...
   Ext.define("Ext.locale.zh_CN.picker.Date", {
      ...
      todayText: "今天",
      minText: "日期必需大于最小允许日期",
      //update
      maxText: "日期必需小于最大允许日期",
      //update
      disabledDaysText: "",
      disabledDatesText: "",
   ...
   Ext.define("Ext.locale.zh_CN.form.field.Text", {
      ...
      minLengthText: "该录入项的最小长度是 {0} 个字符",
      maxLengthText: "该录入项的最大长度是 {0} 个字符",
      blankText: "该录入项为必录项",
      regexText: "",
      emptyText: null
   });
   ...
   Ext.define("Ext.locale.zh_CN.form.field.Date", {
      ...
      minText: "该录入项的日期必需在 {0} 之后",
      maxText: "该录入项的日期必需在 {0} 之前",
      invalidText: "{0} 是无效的日期 - 必需符合格式： {1}",
      format: "Y-m-d"
   });
   ...
   if (exists('Ext.form.field.VTypes')) {
      Ext.apply(Ext.form.field.VTypes, {
         emailText: '该录入项必需是电子邮件地址，格式如： "user@example.com"',
         urlText: '该录入项必需是URL地址，格式如： "http:/' + '/www.example.com"',
         alphaText: '该录入项只能包含半角字母和_',
         //update
         alphanumText: '该录入项只能包含半角字母,数字和_' //update
      });
   }
